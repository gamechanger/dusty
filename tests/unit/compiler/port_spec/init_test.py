...
@patch('dusty.compiler.port_spec.get_docker_vm_ip', return_value='1.1.1.1')
class TestPortSpecCompiler(DustyTestCase):
    ...
    def test_docker_compose_port_spec_1(self, fake_vm_ip):
    ...
    def test_docker_compose_port_spec_2(self, fake_vm_ip):
    ...
    def test_nginx_port_spec_1(self, fake_vm_ip):
    ...
    def test_nginx_port_spec_2(self, fake_vm_ip):
    ...
    def test_get_port_spec_document_1_app(self, fake_vm_ip):
        ...
        correct_port_spec = {'docker_compose':{'gcweb':[{'in_container_port': '80',
                             ...
                             'nginx':[{'proxied_port': '65000',
                                       ...
                                       'host_address': 'local.gc.com',
                                       'host_port': '80'}],
                             'hosts_file':[{'forwarded_ip': '1.1.1.1',
                                            'host_address': 'local.gc.com'}]}
        self.assertEqual(get_port_spec_document(expanded_spec, '192.168.5.10'), correct_port_spec)

    def test_get_port_spec_document_2_apps(self, fake_vm_ip):
        expanded_spec = {'apps':
                                {'gcweb':
                                         {'host_forwarding':[{'host_name': 'local.gc.com',
                                                             'host_port': 80,
    ...
    def test_get_port_spec_document_2_apps_same_host_port(self, fake_vm_ip):
        expanded_spec = {'apps':
                                {'gcweb':
                                         {'host_forwarding':[{'host_name': 'local.gc.com',
                                                             'host_port': 80,
    ...
    def test_port_spec_throws_full_address_error(self, fake_vm_ip):
        expanded_spec = {'apps':
                                {'gcweb':
                                         {'host_forwarding':[{'host_name': 'local.gc.com',
                                                             'host_port': 80,
    ...
    def test_port_spec_throws_container_port(self, fake_vm_ip):
        expanded_spec = {'apps':
                                {'gcweb':
                                         {'host_forwarding':[{'host_name': 'local.gc.com',
                                                             'host_port': 80,
    ...
    def test_app_with_multiple_host_forwardings(self, fake_vm_ip):
        expanded_spec = {'apps':
                                {'gcweb':
                                         {'host_forwarding':[{'host_name': 'local.gc.com',
                                                             'host_port': 80,
