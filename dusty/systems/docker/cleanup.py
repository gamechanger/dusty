...
from . import get_dusty_containers, get_dusty_images, get_docker_client

def get_exited_dusty_containers():
    all_containers = get_dusty_containers(None, include_exited=True)
    stopped_containers = []
